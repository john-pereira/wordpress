			...
			<main>
				<section class="slider">
					<div class="flexslider">
					  <ul class="slides">
						...
						?>
					    <li>
					      <?php the_post_thumbnail( 'jon-lab-slider', array( 'class' => 'img-fluid' ) ); ?>
					      <div class="container">
				...
				<?php if( class_exists( 'WooCommerce' ) ): ?>
					...
					<section class="popular-products">
						...
						<div class="container">
							<div class="section-title">
								<h2><?php echo get_theme_mod( 'set_home_title1', 'Title of section 1' ); ?></h2>
							</div>
					...
					<section class="new-arrivals">
						<div class="container">
							<div class="section-title">
								<h2><?php echo get_theme_mod( 'set_home_title2', 'Title of section 2' ); ?></h2>
							</div>
					...
					<section class="deal-of-the-week">
						<div class="container">
							<div class="section-title">
								<h2><?php echo get_theme_mod( 'set_home_title3', 'Title of section 3' ); ?></h2>
							</div>
												...
												<a href="<?php the_permalink(); ?>">
													<?php 
														if( has_post_thumbnail() ):
															the_post_thumbnail( 'jon-lab-blog', array( 'class' => 'img-fluid' ) );
														endif;
													?>
												</a>
												<h3>
