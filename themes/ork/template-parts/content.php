...
<article <?php post_class(); ?>>
	...
	<div class="meta">
		<p><?php esc_html_e( 'Publicado por', 'ork' ); ?> <?php the_author_posts_link(); ?> <?php esc_html_e( 'em', 'ork' ); ?> <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_the_date() ); ?></a>		<br /> 
		<?php if( has_category() ): ?>
	...
	<?php elseif( strpos( $post->post_content, '<!--more-->' ) ): ?>
		<div class="content"><?php the_content( 'Mais' ); ?></div>
	<?php else: ?>	
		<div class="content"><?php the_excerpt(); ?></div>
	<?php endif; ?>	
</article>