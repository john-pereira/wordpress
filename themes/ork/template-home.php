			...
			<main>
				<section class="slider">
					<div class="flexslider">
					  <ul class="slides">
						...
						?>
					    <li>
					      <?php the_post_thumbnail( 'ork-slider', array( 'class' => 'img-fluid' ) ); ?>
					      <div class="container">
				...
				<?php if( class_exists( 'WooCommerce' ) ): ?>
					...
					<section class="popular-products">
						...
						<div class="container">
							<div class="section-title">
								<h2><?php echo esc_html( get_theme_mod( 'set_home_title1', __('Título da seçao 1', 'ork' ) ) ); ?></h2>
							</div>
					...
					<section class="new-arrivals">
						<div class="container">
							<div class="section-title">
								<h2><?php echo esc_html( get_theme_mod( 'set_home_title2', __('Título da seçao 2', 'ork' ) ) ); ?></h2>
							</div>
					...
					if( $showdeal == 1 && ( !empty( $deal ) ) ):
						$discount_percentage = absint( 100 - ( ( (float)$sale/(float)$regular ) * 100 ) );
					?>
					<section class="deal-of-the-week">
						<div class="container">
							<div class="section-title">
								<h2><?php echo esc_html( get_theme_mod( 'set_home_title3', __('Título da seçao 3', 'ork' ) ) ); ?></h2>
							</div>
							<div class="row d-flex align-items-center">
								...
								<div class="deal-desc col-md-4 col-12 mr-auto text-center">
										<?php if( !empty( $sale ) ): ?>
											<span class="discount">
												<?php echo esc_html( $discount_percentage ) . esc_html__( '% OFF', 'ork' ); ?>
											</span>
										<?php endif; ?>
										<h3>
											<a href="<?php echo esc_html( get_permalink( $deal ) ); ?>"><?php echo esc_html( get_the_title( $deal ) ); ?></a>
										</h3>
										...
										<a href="<?php echo esc_url( '?add-to-cart=' . $deal ); ?>" class="add-to-cart"><?php esc_html_e( 'Adicionar ao Carrinho', 'ork' ); ?></a>
								</div>
							</div>
						</div>
					</section>
				...
				<section class="lab-blog">
					<div class="container">
						<div class="section-title">
							<h2><?php echo esc_html( get_theme_mod( 'set_blog_title', __('Novidades', 'ork' ) ) ); ?></h2>		
						</div>
						<div class="row">
							<?php 
